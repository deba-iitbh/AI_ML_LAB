...
function aiPrediction() {
  ...
  aiChoice =
    1 <= roundedPredicted && roundedPredicted <= 3
      ? (roundedPredicted % 3) + 1
      : 1;
  document.getElementById("ai-" + stringOf(aiChoice) + "-button").className =
    "btn-active";
  updatePattern();
}
...
function checkWin() {
  if (playerChoice === aiChoice) {
    ...
    playerBtnArea.getElementsByClassName("btn-active")[0].className =
      "btn-lose";
  }
